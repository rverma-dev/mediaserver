...
info "Access URLs:"
[[ -n "${DUCKDNS_SUBDOMAIN:-}" ]] && echo "  HTTPS: https://${DUCKDNS_SUBDOMAIN}.duckdns.org"
[[ -n "${DUCKDNS_SUBDOMAIN:-}" ]] && echo "  Seerr: https://${DUCKDNS_SUBDOMAIN}.duckdns.org:9443"
echo ""
...
echo "  /photos     - Immich"
echo "  /           - OpenClaw (catch-all, runs from ~/openclaw)"
echo ""
info "Setup complete."
